"""
оставлен для обратной совместимости, будет удалён в будущем. Используйте main.py для тестов.
"""
...
def main_menu():
    try:
        print(Fore.RED + "оставлен для обратной совместимости, будет удалён в будущем. Используйте main.py для тестов.\n")
        count_timer = 5
        while count_timer > 0:
            print(Fore.YELLOW + f"Оставлен для обратной совместимости, будет удалён в будущем. Используйте main.py для тестов.\n Продолжение через {count_timer} секунд...", end='\r')
            time.sleep(1)
            count_timer -= 1
