"""Адаптер прокси для Abstract Portal — обёртка над modules.proxy_manager."""
import random
from modules.data_manager import load_data


class AbsProxyManager:
    """Прокси-менеджер для Abstract Portal с поддержкой 1:1 привязки, резерва и aiohttp."""
