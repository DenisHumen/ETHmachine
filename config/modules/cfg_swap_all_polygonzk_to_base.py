# ========================================================================================
# НАСТРОЙКИ модуля 🩸 Drainer Polygon zkEVM → Base USDC
# ========================================================================================
# Маршруты Layerswap:
...
# Здесь — только специфичные для дрейнера.

# --- Параметры дрейнера ---
# Жёсткий floor резерва ETH (Polygon zkEVM) на газ. 0 = дрейнить максимально
